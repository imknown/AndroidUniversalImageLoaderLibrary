...
public class ImageLoader {
	...
	/**
	 * Returns <b>true</b> - if ImageLoader {@linkplain #init(ImageLoaderConfiguration) is initialized with configuration}; <b>false</b> - otherwise
	 */
	 ...
	 * Default {@linkplain DisplayImageOptions display image options} from {@linkplain ImageLoaderConfiguration configuration} will be used.<br />
	 * <b>NOTE:</b> {@link #init(ImageLoaderConfiguration)} method must be called before this method call
	 *
	 * @param uri
	 *            Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
	 * @param imageAware
	 *            {@linkplain com.nostra13.universalimageloader.core.imageaware.ImageAware Image aware view} which should display image
	 ...
	 *            {@linkplain com.nostra13.universalimageloader.core.imageaware.ImageAware Image aware view} which should display image
	 * @param listener
	 *            {@linkplain ImageLoadingListener Listener} for image loading process. Listener fires events on UI thread if this method is called on UI thread.
	 * @throws IllegalStateException
	 *             if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException
	 *             if passed <b>imageAware</b> is null
	 ...
	 *            {@linkplain com.nostra13.universalimageloader.core.imageaware.ImageAware Image aware view} which should display image
	 * @param options
	 *            {@linkplain com.nostra13.universalimageloader.core.DisplayImageOptions Options} for image decoding and displaying. If <b>null</b> - default display image options {@linkplain ImageLoaderConfiguration.Builder#defaultDisplayImageOptions(DisplayImageOptions) from configuration} will be used.
	 * @throws IllegalStateException
	 *             if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException
	 *             if passed <b>imageAware</b> is null
	...
	/**
	 * Adds load image task to execution pool. Image will be returned with {@link ImageLoadingListener#onLoadingComplete(String, android.view.View, android.graphics.Bitmap)} callback}. <br />
	 * <b>NOTE:</b> {@link #init(ImageLoaderConfiguration)} method must be called before this method call
	 *
	 * @param uri
	 *            Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
	 ...
	 *            Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
	 * @param options
	 *            {@linkplain com.nostra13.universalimageloader.core.DisplayImageOptions Options} for image decoding and displaying. If <b>null</b> - default display image options {@linkplain ImageLoaderConfiguration.Builder#defaultDisplayImageOptions(DisplayImageOptions) from configuration} will be used.<br />
	 * @param listener
	 *            {@linkplain ImageLoadingListener Listener} for image loading process. Listener fires events on UI thread if this method is called on UI thread.
	 * @throws IllegalStateException
	 *             if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 ...
	 * Default display image options {@linkplain ImageLoaderConfiguration.Builder#defaultDisplayImageOptions(DisplayImageOptions) from configuration} will be used.<br />
	 * <b>NOTE:</b> {@link #init(ImageLoaderConfiguration)} method must be called before this method call
	 *
	 * @param uri
	 *            Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
	 ...
	 *            Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
	 * @param options
	 *            {@linkplain com.nostra13.universalimageloader.core.DisplayImageOptions Options} for image decoding and scaling. If <b>null</b> - default display image options {@linkplain ImageLoaderConfiguration.Builder#defaultDisplayImageOptions(DisplayImageOptions) from configuration} will be used.
	 * @return Result image Bitmap. Can be <b>null</b> if image loading/decoding was failed or cancelled.
	 * @throws IllegalStateException
	 *             if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	 ...
	 *            Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
	 * @param targetImageSize
	 *            Minimal size for {@link Bitmap} which will be returned. Downloaded image will be decoded and scaled to {@link Bitmap} of the size which is <b>equal or larger</b> (usually a bit larger) than incoming targetImageSize.
	 * @return Result image Bitmap. Can be <b>null</b> if image loading/decoding was failed or cancelled.
	 * @throws IllegalStateException
	 *             if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	...
	/**
	 * Returns URI of image which is loading at this moment into passed {@link com.nostra13.universalimageloader.core.imageaware.ImageAware ImageAware}
	 */
	...
	/**
	 * Cancel the task of loading and displaying image for passed {@link com.nostra13.universalimageloader.core.imageaware.ImageAware ImageAware}.
	 *
	 * @param imageAware
	 *            {@link com.nostra13.universalimageloader.core.imageaware.ImageAware ImageAware} for which display task will be cancelled
	 */
	 ...
	 *
	 * @param imageView
	 *            {@link android.widget.ImageView ImageView} for which display task will be cancelled
	 */
	 ...
	 * <br />
	 * If downloads are denied and if image isn't cached then {@link ImageLoadingListener#onLoadingFailed(String, View, FailReason)} callback will be fired with {@link FailReason.FailType#NETWORK_DENIED}
	 *
	 * @param denyNetworkDownloads
	 *            pass <b>true</b> - to deny engine to download images from the network; <b>false</b> - to allow engine to download images from network.
	 */
	...
	/**
	 * Sets option whether ImageLoader will use {@link FlushedInputStream} for network downloads to handle <a href="http://code.google.com/p/android/issues/detail?id=6066">this known problem</a> or not.
	 *
	 ...
	 * <b>NOTE:</b> This method doesn't shutdown {@linkplain com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor) custom task executors} if you set them.<br />
	 ...
	 * You can {@linkplain #init(ImageLoaderConfiguration) init} ImageLoader with new configuration after calling this method.
	 */
	public void destroy() {
		if (configuration != null)
			L.d(LOG_DESTROY);
