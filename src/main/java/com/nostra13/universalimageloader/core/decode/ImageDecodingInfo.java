...
public class ImageDecodingInfo {
	...
	/**
	 * @return Target size for image. Decoded bitmap should close to this size according to {@linkplain ImageScaleType image scale type} and {@linkplain ViewScaleType view scale type}.
	 */
