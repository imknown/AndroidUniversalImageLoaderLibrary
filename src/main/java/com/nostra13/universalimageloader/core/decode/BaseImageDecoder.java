...
public class BaseImageDecoder implements ImageDecoder {
	 ...
	 *            Whether debug logs will be written to LogCat. Usually should match {@link com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder#writeDebugLogs() ImageLoaderConfiguration.writeDebugLogs()}
	 */
