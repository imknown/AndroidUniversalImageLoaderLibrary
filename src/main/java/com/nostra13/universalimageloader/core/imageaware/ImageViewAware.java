...
public class ImageViewAware extends ViewAware {
	 ...
	 *            <b>true</b> - then {@link #getWidth()} and {@link #getHeight()} will check actual size of ImageView. It can cause known issues like <a href="https://github.com/nostra13/Android-Universal-Image-Loader/issues/376">this</a>. But it helps to save memory because memory cache keeps bitmaps of actual (less in general) size.
	 *            <p/>
	 *            <b>false</b> - then {@link #getWidth()} and {@link #getHeight()} will <b>NOT</b> consider actual size of ImageView, just layout parameters. <br />
