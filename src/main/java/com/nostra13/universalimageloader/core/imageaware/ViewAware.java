...
public abstract class ViewAware implements ImageAware {
	 ...
	 *
	 * @param view
	 *            {@link android.view.View View} to work with
	 */
	 ...
	 *            <b>true</b> - then {@link #getWidth()} and {@link #getHeight()} will check actual size of View. It can cause known issues like <a href="https://github.com/nostra13/Android-Universal-Image-Loader/issues/376">this</a>. But it helps to save memory because memory cache keeps bitmaps of actual (less in general) size.
	 *            <p/>
	 *            <b>false</b> - then {@link #getWidth()} and {@link #getHeight()} will <b>NOT</b> consider actual size of View, just layout parameters. <br />
	 ...
	 * {@inheritDoc}
	 * <p/>
	 * Width is defined by target {@link android.view.View view} parameters, configuration parameters or device display dimensions.<br />
	 ...
	 * {@inheritDoc}
	 * <p/>
	 * Height is defined by target {@link android.view.View view} parameters, configuration parameters or device display dimensions.<br />
	 * Size computing algorithm (go by steps until get non-zero value):<br />
