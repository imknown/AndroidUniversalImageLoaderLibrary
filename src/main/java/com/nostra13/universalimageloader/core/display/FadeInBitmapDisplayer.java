...
public class FadeInBitmapDisplayer implements BitmapDisplayer {
	...
	public void display(Bitmap bitmap, ImageAware imageAware, LoadedFrom loadedFrom) {
		...
		if ((animateFromNetwork && loadedFrom == LoadedFrom.NETWORK) || (animateFromDisk && loadedFrom == LoadedFrom.DISC_CACHE) || (animateFromMemory && loadedFrom == LoadedFrom.MEMORY_CACHE)) {
