...
class ImageLoaderEngine {
	 ...
	 *
	 * @param imageAware
	 *            {@link com.nostra13.universalimageloader.core.imageaware.ImageAware} for which display task will be cancelled
	 */
	 ...
	 * <b>NOTE:</b> This method doesn't shutdown {@linkplain com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor) custom task executors} if you set them.
	 */
	void stop() {
