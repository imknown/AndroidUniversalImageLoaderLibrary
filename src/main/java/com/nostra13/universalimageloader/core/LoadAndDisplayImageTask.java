...
/**
 * Presents load'n'display image task. Used to load image from Internet or file system, decode it to {@link Bitmap}, and display it in {@link com.nostra13.universalimageloader.core.imageaware.ImageAware} using {@link DisplayBitmapTask}.
 *
...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
	 ...
	 *             if task is not actual (target ImageAware is collected by GC or the image URI of this task doesn't match to image URI which is actual for current ImageAware at this moment)
	 */
	...
	/**
	 * @return <b>true</b> - if task is not actual (target ImageAware is collected by GC or the image URI of this task doesn't match to image URI which is actual for current ImageAware at this moment)); <b>false</b> - otherwise
	 */
	...
	/**
	 * Exceptions for case when task is cancelled (thread is interrupted, image view is reused for another task, view is collected by GC).
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.9.1
	 */
