...
/**
 * Disk cache based on "Least-Recently Used" principle. Adapter pattern, adapts {@link com.nostra13.universalimageloader.cache.disc.impl.ext.DiskLruCache DiskLruCache} to {@link com.nostra13.universalimageloader.cache.disc.DiskCache DiskCache}
 *
...
public class LruDiskCache implements DiskCache {
	 ...
	 *            {@linkplain com.nostra13.universalimageloader.cache.disc.naming.FileNameGenerator Name generator} for cached files. Generated names must match the regex <strong>[a-z0-9_-]{1,64}</strong>
	 * @param cacheMaxSize
	 *            Max cache size in bytes. <b>0</b> means cache size is unlimited.
	 * @throws IOException
	 *             if cache can't be initialized (e.g. "No space left on device")
	 */
	 ...
	 *            Max file count in cache. <b>0</b> means file count is unlimited.
	 * @throws IOException
	 *             if cache can't be initialized (e.g. "No space left on device")
	 */
