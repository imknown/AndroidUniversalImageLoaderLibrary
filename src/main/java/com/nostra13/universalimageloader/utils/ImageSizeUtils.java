...
public final class ImageSizeUtils {
	...
	/**
	 * Computes sample size for downscaling image size (<b>srcSize</b>) to view size (<b>targetSize</b>). This sample size is used during {@linkplain BitmapFactory#decodeStream(java.io.InputStream, android.graphics.Rect, android.graphics.BitmapFactory.Options) decoding image} to bitmap.<br />
	 * <br />
	 * <b>Examples:</b><br />
	 * <p/>
	 * 
	 ...
	 *            Target (view) size
	 * @param viewScaleType
	 *            {@linkplain ViewScaleType Scale type} for placing image in view
	 * @param powerOf2Scale
	 ...
	 *            {@linkplain ViewScaleType Scale type} for placing image in view
	 * @param stretch
	 *            Whether source size should be stretched if target size is larger than source size. If <b>false</b> then result scale value can't be greater than 1.
